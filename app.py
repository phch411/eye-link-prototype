    ...
    def show_login_page(self):
        ...
        with col:
            ...
            with st.container(border=True):
                u_id = st.text_input("학교 아이디 (school_id)", placeholder="admin")
                u_pw = st.text_input("비밀번호", type="password", placeholder="admin")
